...
public class DatabaseViSao {
    ...
    public DatabaseViSao(Context context) {
    ...
    public ArrayList<String> getMusicList2() {
        ArrayList<String> musicList = new ArrayList<>();
        Cursor c = database.query("ViSaoTheNhi", null, null, null, null, null, null);
        if (c.moveToFirst()) {
            do {
    ...
    public ArrayList<String> getArtistList2() {
