...
public class DatabaseGiang {
    ...
    public DatabaseGiang(Context context) {
    ...
    public ArrayList<String> getMusicList1() {
        ArrayList<String> musicList = new ArrayList<>();
        Cursor c = database.query("GiangOiRadio", null, null, null, null, null, null);
        if (c.moveToFirst()) {
            do {
    ...
    public ArrayList<String> getArtistList1() {
